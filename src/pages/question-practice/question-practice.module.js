...
import { QuestionPracticePage } from './question-practice';
var QuestionPracticePageModule = /** @class */ (function () {
    ...
    QuestionPracticePageModule = __decorate([
        NgModule({
            ...
            imports: [
                IonicPageModule.forChild(QuestionPracticePage),
            ],
        })
    ], QuestionPracticePageModule);
    return QuestionPracticePageModule;
}());
export { QuestionPracticePageModule };
