        ...
        return new Promise(function (resolve, reject) {
            ...
            surveys.forEach(function (value, key) {
                ...
                _this.AioneService.SelectWhere("questions", "survey_id", value.id).then(function (questionData) {
                    ...
                    keyColumns.push('ip_address', 'survey_startedOn', 'survey_completedOn', 'survey_submittedBy', 'survey_submittedFrom', 'mac_address', 'unique_id', 'device_detail', 'totalQuestions', 'filledQuestions', 'last_fieldId', 'last_group_id', 'completed_groups', 'survey_status', 'incomplete_name', 'survey_sync_status', 'record_type');
...
var IncompletedSurveyPage = (function () {
    ...
    IncompletedSurveyPage.prototype.resume = function (id, group) {
        console.log(id);
        console.log(group);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__pages_survey_questions_survey_questions__ = __webpack_require__(279);
