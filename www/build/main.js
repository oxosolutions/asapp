...
var QuestionPage = (function () {
                ...
                },
                {
                    ...
                    handler: function (data) {
                        if (data[0] == "") {
                            ...
                            var query = "UPDATE " + _this.tablename + " SET " + "survey_status" + "= '" + formValue + "'" + " where serialNo = " + localStorage.getItem('record_id');
                            console.log(query);
    ...
    QuestionPage.prototype.next = function (surveyid, questionkey) {
        ...
        if (this.questionCheck.length == (questionLength - 1)) {
            ...
            var query = "UPDATE " + this.tablename + " SET completed_groups = '" + localStorage.getItem('Groupid') + "'" + " where serialNo = " + localStorage.getItem('record_id');
    ...
    QuestionPage.prototype.onSubmit = function (form, questionKey, survey_id, questionText, QuestionType) {
        ...
        if (!this.formValidate) {
            ...
            if (record_id != "null") {
                console.log('update');
                var query_1 = "UPDATE " + this.tablename + " SET " + questionKey + "= '" + formValue_1 + "', last_fieldId = " + localStorage.getItem("lastquestionIndex") + " where serialNo = " + localStorage.getItem('record_id');
                console.log(query_1);
                ...
                this.servicesProvider.Insert(this.tablename, [questionKey, "last_fieldId"], formValue_1).then(function (res) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__ionic_native_geolocation__ = __webpack_require__(202);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_text_text__ = __webpack_require__(280);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_incompleted_survey_incompleted_survey__ = __webpack_require__(137);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_incompleted_survey_incompleted_survey__ = __webpack_require__(137);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
